{self, inputs, ...}: {
    ...
    in
  {
    ...
    # inputs.nixpkgs.overlays = [ inputs.niri.overlays.niri ];
      ...
      settings = {
        ...
        binds =
          ...
          in
          {
            ...
            "Super+Return".action = spawn "kitty"; # terminal
            ...
            "XF86AudioMute".action = sh "swayosd-client --monitor HDMI-A-1 --output-volume mute-toggle";
            "XF86AudioMicMute".action = sh "swayosd-client --monitor HDMI-A-1 --input-volume mute-toggle";
            "XF86AudioPlay".action = sh "swayosd-client --monitor HDMI-A-1 --playerctl play-pause";
            "XF86AudioPrev".action = sh "playerctl previous";
            "XF86AudioNext".action = sh "playerctl next";
            "XF86AudioRaiseVolume".action = sh "swayosd-client --monitor HDMI-A-1 --output-volume +5";
            "XF86AudioLowerVolume".action = sh "swayosd-client --monitor HDMI-A-1 --output-volume -5";
            "XF86MonBrightnessUp".action = sh "swayosd-client --monitor HDMI-A-1 --brightness +25";
            "XF86MonBrightnessDown".action = sh "swayosd-client --monitor HDMI-A-1 --brightness -25";
            ...
            "Super+Alt+K".action = sh "swayosd-client --monitor HDMI-A-1 --playerctl play-pause";
          };
