...
#  "zen.view.sidebar-expanded" = true;
  ...
  "general.smoothScroll.lines.durationMaxMS" = 65;
  "general.smoothScroll.lines.durationMinMS" = 25;
  "general.smoothScroll.mouseWheel.durationMaxMS" = 100;
  "general.smoothScroll.mouseWheel.durationMinMS" = 50;
  "general.smoothScroll.msdPhysics.enabled" = true;
  "general.smoothScroll.other.durationMaxMS" = 60;
  "general.smoothScroll.other.durationMinMS" = 60;
  "general.smoothScroll.pages.durationMaxMS" = 60;
  "general.smoothScroll.pages.durationMinMS" = 125;
  "mousewheel.min_line_scroll_amount" = 15;
  "mousewheel.system_scroll_override_on_root_content.enabled" = true;
  "mousewheel.system_scroll_override_on_root_content.horizontal.factor" = 80;
  "mousewheel.system_scroll_override_on_root_content.vertical.factor" = 80;
  "toolkit.scrollbox.horizontalScrollDistance" = 3;
