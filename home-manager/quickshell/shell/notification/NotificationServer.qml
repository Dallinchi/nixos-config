...
//import quickshell.modules.common
//import quickshell
import QtQuick
import Quickshell
...
Singleton {
	...
	onNotification: (notification) => {
	    ...
	    const notificationText = notification.body; // Получаем текст уведомления
            const notificationTitle = notification.appName; // Получаем заголовок уведомления
            console.log("Notification Title:", notificationTitle);
            console.log("Notification Body:", notificationText);
